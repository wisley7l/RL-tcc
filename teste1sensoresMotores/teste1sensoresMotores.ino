...
int lim = 70;//120;// define o limite entre o branco e o preto
...
//    delay(1000);
  //*
  //esquerda branco, direita preto &&valorCantoEsq < lim  &&  valorCantoDir < lim
  if (valorLinhaEsq < lim  &&  valorLinhaDir > lim && valorCantoEsq > lim  &&  valorCantoDir > lim) {

    motores.Direita100(v);
    e2 = estado;
    estado = 3;
  ...
  else if (valorLinhaEsq > lim  && valorLinhaDir < lim &&valorCantoEsq > lim  &&  valorCantoDir > lim) {
    
    motores.Esquerda100(v);
